...
補完はnvim-cmpに統合。補完メニューにCopilotの候補が他のLSP候補と一緒に表示される。
...
| `,ccp` | Telescopeでアクション選択 (ノーマル/ビジュアル) |
| `,ce` | コードの説明 |
| `,cr` | コードレビュー |
| `,cf` | バグ修正 |
| `,co` | コード最適化 |
| `,ct` | テスト生成 |
| `,cco` | コミットメッセージ生成 (git diff) |

使い方: コードをビジュアル選択 → `,ccp` でアクション選択、または `,cc` でチャットを開いて直接質問。

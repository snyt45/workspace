...
- Mission Control（システム設定 > デスクトップとDock > Mission Control）
  - 設定
    - 最新の使用状況に基づいて操作スペースを自動的に並べる ON
    - アプリケーションの切り替えで、アプリケーションのウィンドウが開いている操作スペースに移動 ON
    - ウィンドウをアプリケーションごとにグループ化 ON
    - ディスプレイごとに個別の操作スペース ON
    - ウィンドウを画面上部にドラッグしてMission Controleに入る ON
  - ホットコーナー
    - 左上：なし
    - 左下：デスクトップ
    - 右上：アプリケーションウィンドウ
